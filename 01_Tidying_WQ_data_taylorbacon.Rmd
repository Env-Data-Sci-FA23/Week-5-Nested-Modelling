...
```{r}
#Create a function "clean_conc_data" that repeats the steps above
clean_conc_data <- function(site_IDs){
...
```{r}
conc_daily2 <- clean_conc_data(additional_data)
```
...
```{r}
#<<<< YOUR CODE HERE >>>>#
wq <- bind_rows(conc_daily,conc_daily2)
